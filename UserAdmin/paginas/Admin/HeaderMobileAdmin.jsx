...
const HeaderMobileAdmin = () => {
  ...
  return (
    <>
    <div onClick={() => navigate1("/")} className="hover:cursor-pointer flex justify-center items-center flex-row gap-[5px] lg:ml-44 xl:ml-0 lg:w-1/4 xl:w-1/5 h-[59.34px] mt-[2.84px]">
