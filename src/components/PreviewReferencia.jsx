    ...
    className=' bg-[#373737] hover:bg-[#FF5E59] h-[394.07px] w-[240.17px] gap-1 p-2 rounded-[24.43px] m-1'>
      ...
      <div className='flex flex-col'>
        <div className='w-fit pl-4 pr-4 pb-4'>
          ...
          <div
            className={`${!agotado ? 'bg-white' : 'bg-white text-black'} gap-[10.65px] p-[10.65px] mt-[25px] w-fit px-4 py-3 text-[#8F00FF] uppercase font-bold text-[14.9167px] rounded-[22.38px]`}
